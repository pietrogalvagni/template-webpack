export default class InteractiveHandler {
    constructor(scene) {
        ...
        scene.dealCards.on('pointerdown', () => {
            console.log("InteractiveHandler: dealCards to " + scene.socket.id);
        ...
        // Pass turn button
        scene.passTurn.on('pointerdown', ()=>{
            console.log("InteractiveHandler: passTurn invoked by " + scene.socket.id);
